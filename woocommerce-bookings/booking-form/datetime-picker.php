...
<fieldset class="wc-bookings-date-picker <?php echo implode( ' ', $class ); ?>">
	<legend>
		<span class="label"><?php _e( 'Choose a date', 'woocommerce-bookings' ); ?></span> <abbr class="required" title="Required field">*</abbr> <small class="wc-bookings-date-picker-choose-date"><?php _e( 'Choose...', 'woocommerce-bookings' ); ?></small>
	</legend>
...
<div class="form-field form-field-wide">
	<label for="<?php echo $name; ?>"><?php _e( 'Choose a start time', 'woocommerce-bookings' ); ?> <abbr class="required" title="Required field">*</abbr></label>
